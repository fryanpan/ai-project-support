...
- **Haiku for low-intelligence polling loops:** CI waits, event watches, retry loops — use Haiku, not Sonnet. Meaningfully cheaper per poll.
...
- When you do write delegation prompts or skill instructions, be specific and concrete. "Prefer X unless Y" is too vague — use explicit decision criteria and concrete examples.
