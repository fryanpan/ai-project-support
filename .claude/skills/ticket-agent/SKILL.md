...
- **You own the full PR lifecycle.** Create the PR, monitor CI via `gh pr checks`, fix failures, and merge it yourself.
...
- Wait 60 seconds, then run `gh pr checks <pr-url>`
